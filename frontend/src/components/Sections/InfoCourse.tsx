...
export default function InfoCourse() {
    return (
        ...
        <div className="flex items-center justify-center bg-primary">
            ...
            <div className="flex max-w-6xl max-h-2xl bg-secondary overflow-hidden">
                <div className="w-1/2">
                    <motion.img
                ...
                <div className="col-lg-6 pt-4 pt-lg-0 content p-6">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="">
                        <Link to="/" className="bg-primaryText hover:bg-primaryTextHover rounded-lg p-2 max-w-44 flex items-center justify-center mt-6 text-gray-800">Proceed to Checkout</Link>
                    </motion.div>
                </div>
            </div>
        </div>
