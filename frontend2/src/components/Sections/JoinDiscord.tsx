      ...
      <motion.div
        ...
        <div className="flex gap-4">
          <motion.button 
            ...
            viewport={{ once: true }}
            className="flex items-center gap-2 bg-white text-black px-4 py-2 rounded-lg hover:bg-slate-200 transition">
          ...
          <motion.button
            ...
            transition={{ duration: 0.4 }}
            viewport={{ once: true }}
            className="flex items-center gap-2 bg-primaryColor text-white px-4 py-2 rounded-lg hover:bg-primaryColorHover transition">
