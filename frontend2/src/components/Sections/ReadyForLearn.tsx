...
export default function ReadyToGetFunded() {
  return (
    <article className="relative w-full max-w-6xl mx-auto rounded-3xl overflow-hidden border-4 border-white mb-20">
      ...
      <div className="relative z-10 px-4 py-16 lg:p-16 flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-36">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mx-2">
          <a href="https://www.fundraiser.com/apply">
            <button className="justify-center lg:justify-start w-full lg:w-auto NHBold border-white border-[1px] bg-white py-4 px-8 text-2xl rounded-full transition-all duration-500 text-fund-bg hover:bg-fund-bg hover:text-white hover:border-fund-bg">
